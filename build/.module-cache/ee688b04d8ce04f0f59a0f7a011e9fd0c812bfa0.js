  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: divclass}, 
        React.createElement("p", {className: topPClass}, " ", React.createElement("span", null, "\"1\""), " ", this.state.title, "'s last gist is (", React.createElement("a", {href: this.state.url}, "here"), "). ")
      )
    );
  }
});
