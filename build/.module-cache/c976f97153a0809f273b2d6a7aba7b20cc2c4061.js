  ...
  render: function() {
    ...
    return (
      React.createElement("div", {className: divclass}, 
        React.createElement("p", {className: topPClass}, " ", React.createElement("span", null, "1."), React.createElement("img", {src: "./images/uparrow.gif"}), " ", this.state.title, " ", React.createElement("span", null, " (", React.createElement("a", {href: this.state.url}, " ", this.state.url, " "), "). "), " ")
      )
    );
  }
});
