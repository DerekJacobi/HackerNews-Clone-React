...
React.render(
  React.createElement(Story, {source: "https://hacker-news.firebaseio.com/v0/topstories.json?print=pretty", title: "Hello"}),
  newstories
);
...
var Story = React.createClass({displayName: "Story",
  ...
  componentDidMount: function() {
      var story = result;
      source="https://hacker-news.firebaseio.com/v0/item/10132935.json?print=pretty"
      if (this.isMounted()) {
        this.setState({
          by: story.by,
          score: story.score,
